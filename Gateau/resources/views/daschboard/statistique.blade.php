            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Manage <b>Categorie</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Ajouter une categorie</span></a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            {{-- @foreach ($categorie as $categorie) --}}
                                ...
                                <td>name</td>
                                <td>
                                    {{-- <a type="submit" href="/page_updateevent?id={{$event->id}}" class="btn btn-success">Update</a> --}}
                                    <a href="" class="text-red-600" data-toggle="modal" >update</a>
                                     {{-- <a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a> 
                                    <a href="/deleteCategorie?id={{$categorie->id}}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a> --}}
                                    {{-- <a href="/deleteCategorie?id={{$categorie->id}}" class="text-red-600" >Supprimer</a> --}}
                                </td>
                            </tr>
                            {{-- @endforeach  --}}
                         </tbody>
